    ...
    return (
        <main className="flex flex-1 flex-col gap-4 p-4 lg:p-6 bg-neutral-900 h-screen">
            <div className="flex items-center">
                <Breadcrumb className="hidden md:flex pb-3 px-6">
                    <BreadcrumbList>
                        ...
                        <BreadcrumbItem>
                            <BreadcrumbLink asChild>
                                <Link href={`/dashboard/promotionss/${preparedPromoDetails.id}`}>Editing {preparedPromoDetails.name}</Link>
                            </BreadcrumbLink>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
            ...
            <div className="bg-black border border-neutral-600 px-[25%] py-[4%] rounded-xl w-full self-center">
                <AddNewPromotion btnTitle="Update" authenticatedUserId={user.id} promoDetails={preparedPromoDetails}></AddNewPromotion>
            </div>
        </main>
    );
}
