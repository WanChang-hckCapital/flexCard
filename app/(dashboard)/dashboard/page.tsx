          ...
          <div className="grid auto-rows-max items-start gap-4 md:gap-4 lg:col-span-2">
              ...
              <Card className="sm:col-span-2">
                <CardHeader className="pb-3">
                  ...
                  <CardDescription className="max-w-lg text-balance leading-relaxed">
                    Create New SuperType Account for User, free to use, hold for
                    life.
                  </CardDescription>
                </CardHeader>
                <CardFooter>
            ...
            <div className="grid gap-4">
              <ChartCard
                ...
                <SubscriptionsByDayChart
                  startDate={totalSubscriptionRangeOption.startDate}
                  endDate={totalSubscriptionRangeOption.endDate}
                />
              </ChartCard>
              <ChartCard
                title="New Members"
                ...
                <MembersByDayChart
                  startDate={newMembersRangeOption.startDate}
                  endDate={newMembersRangeOption.endDate}
                />
              </ChartCard>
              <ChartCard
                title="Total Members"
                ...
                <MembersTotalByTypeChart
                  startDate={totalMembersRangeType.startDate}
                  endDate={totalMembersRangeType.endDate}
                />
              </ChartCard>
              <ChartCard title="Anaylsis by Country">
